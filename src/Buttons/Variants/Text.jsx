...
import { textDisabledStyle } from "./style";
...
function Text({
  ...
  return (
    <button
      style={
        (disableShadow && style) ||
        (disabled && textDisabledStyle) ||
        (size && overrideStyles) ||
        (color && overrideStyles)
      }
      disabled={disabled}
      className="p-2 bg-transparent rounded-md text-[#3D5AFE] hover:bg-[#2962FF1A] transition flex items-center justify-center"
